...
from app.utils.shell_cmds import logerr
...
class SimilarityGraph:
    ...
    def __init__(self, ExpName, RefOrg, in_fname, out_fname, SaveDir, is_eval=True) -> None:
        self.a = {
            "folder_stem": f"{SaveDir}/{ExpName}/",
            "ref_org": f"{RefOrg}",
            "in_fname": in_fname,
            "out_fname": out_fname
        }
...
def call_graph(seq_name, org, aln_file, out_fname, SaveDir, is_eval=True) -> None:
